...
export const POKEMON_LIST: PokemonEntry[] = [
  ...
  { id: 172, name: 'Pichu' }, { id: 173, name: 'Cleffa' }, { id: 174, name: 'Igglybuff' },
  ...
  { id: 236, name: 'Tyrogue' }, { id: 237, name: 'Hitmontop' },
  ...
  { id: 261, name: 'Poochyena' }, { id: 262, name: 'Mightyena' },
  { id: 263, name: 'Zigzagoon' }, { id: 264, name: 'Linoone' },
  { id: 265, name: 'Wurmple' }, { id: 266, name: 'Silcoon' }, { id: 267, name: 'Beautifly' },
  ...
  { id: 276, name: 'Taillow' }, { id: 277, name: 'Swellow' },
  { id: 278, name: 'Wingull' }, { id: 279, name: 'Pelipper' },
  { id: 280, name: 'Ralts' }, { id: 281, name: 'Kirlia' }, { id: 282, name: 'Gardevoir' },
  ...
  { id: 293, name: 'Whismur' }, { id: 294, name: 'Loudred' }, { id: 295, name: 'Exploud' },
  { id: 296, name: 'Makuhita' }, { id: 297, name: 'Hariyama' },
  { id: 298, name: 'Azurill' },
  ...
  { id: 311, name: 'Plusle' }, { id: 312, name: 'Minun' },
  ...
  { id: 322, name: 'Numel' }, { id: 323, name: 'Camerupt' },
  { id: 324, name: 'Torkoal' },
  { id: 325, name: 'Spoink' }, { id: 326, name: 'Grumpig' },
  { id: 327, name: 'Spinda' },
  { id: 328, name: 'Trapinch' }, { id: 329, name: 'Vibrava' }, { id: 330, name: 'Flygon' },
  { id: 331, name: 'Cacnea' }, { id: 332, name: 'Cacturne' },
  { id: 333, name: 'Swablu' }, { id: 334, name: 'Altaria' },
  { id: 335, name: 'Zangoose' },
  { id: 336, name: 'Seviper' },
  { id: 337, name: 'Lunatone' }, { id: 338, name: 'Solrock' },
  ...
  { id: 380, name: 'Latias' }, { id: 381, name: 'Latios' },
  { id: 382, name: 'Kyogre' }, { id: 383, name: 'Groudon' }, { id: 384, name: 'Rayquaza' },
  { id: 385, name: 'Jirachi' }, { id: 386, name: 'Deoxys' },
  ...
  { id: 408, name: 'Cranidos' }, { id: 409, name: 'Rampardos' },
  { id: 410, name: 'Shieldon' }, { id: 411, name: 'Bastiodon' },
  { id: 412, name: 'Burmy' }, { id: 413, name: 'Wormadam' }, { id: 414, name: 'Mothim' },
  { id: 415, name: 'Combee' }, { id: 416, name: 'Vespiquen' },
  { id: 417, name: 'Pachirisu' },
  { id: 418, name: 'Buizel' }, { id: 419, name: 'Floatzel' },
  { id: 420, name: 'Cherubi' }, { id: 421, name: 'Cherrim' },
  { id: 422, name: 'Shellos' }, { id: 423, name: 'Gastrodon' },
  { id: 424, name: 'Ambipom' },
  { id: 425, name: 'Drifloon' }, { id: 426, name: 'Drifblim' },
  { id: 427, name: 'Buneary' }, { id: 428, name: 'Lopunny' },
  { id: 429, name: 'Mismagius' },
  { id: 430, name: 'Honchkrow' },
  { id: 431, name: 'Glameow' }, { id: 432, name: 'Purugly' },
  { id: 433, name: 'Chingling' },
  { id: 434, name: 'Stunky' }, { id: 435, name: 'Skuntank' },
  ...
  { id: 483, name: 'Dialga' }, { id: 484, name: 'Palkia' },
  { id: 485, name: 'Heatran' },
  { id: 486, name: 'Regigigas' },
  { id: 487, name: 'Giratina' },
  { id: 488, name: 'Cresselia' },
  { id: 489, name: 'Phione' }, { id: 490, name: 'Manaphy' },
  { id: 491, name: 'Darkrai' },
  { id: 492, name: 'Shaymin' },
  { id: 493, name: 'Arceus' },
  ...
  { id: 504, name: 'Patrat' }, { id: 505, name: 'Watchog' },
  { id: 506, name: 'Lillipup' }, { id: 507, name: 'Herdier' }, { id: 508, name: 'Stoutland' },
  { id: 509, name: 'Purrloin' }, { id: 510, name: 'Liepard' },
  { id: 511, name: 'Pansage' }, { id: 512, name: 'Simisage' },
  { id: 513, name: 'Pansear' }, { id: 514, name: 'Simisear' },
  { id: 515, name: 'Panpour' }, { id: 516, name: 'Simipour' },
  { id: 517, name: 'Munna' }, { id: 518, name: 'Musharna' },
  { id: 519, name: 'Pidove' }, { id: 520, name: 'Tranquill' }, { id: 521, name: 'Unfezant' },
  { id: 522, name: 'Blitzle' }, { id: 523, name: 'Zebstrika' },
  { id: 524, name: 'Roggenrola' }, { id: 525, name: 'Boldore' }, { id: 526, name: 'Gigalith' },
  { id: 527, name: 'Woobat' }, { id: 528, name: 'Swoobat' },
  { id: 529, name: 'Drilbur' }, { id: 530, name: 'Excadrill' },
  { id: 531, name: 'Audino' },
  { id: 532, name: 'Timburr' }, { id: 533, name: 'Gurdurr' }, { id: 534, name: 'Conkeldurr' },
  { id: 535, name: 'Tympole' }, { id: 536, name: 'Palpitoad' }, { id: 537, name: 'Seismitoad' },
  { id: 538, name: 'Throh' }, { id: 539, name: 'Sawk' },
  { id: 540, name: 'Sewaddle' }, { id: 541, name: 'Swadloon' }, { id: 542, name: 'Leavanny' },
  { id: 543, name: 'Venipede' }, { id: 544, name: 'Whirlipede' }, { id: 545, name: 'Scolipede' },
  { id: 546, name: 'Cottonee' }, { id: 547, name: 'Whimsicott' },
  { id: 548, name: 'Petilil' }, { id: 549, name: 'Lilligant' },
  { id: 550, name: 'Basculin' },
  { id: 551, name: 'Sandile' }, { id: 552, name: 'Krokorok' }, { id: 553, name: 'Krookodile' },
  { id: 554, name: 'Darumaka' }, { id: 555, name: 'Darmanitan' },
  { id: 556, name: 'Maractus' },
  { id: 557, name: 'Dwebble' }, { id: 558, name: 'Crustle' },
  { id: 559, name: 'Scraggy' }, { id: 560, name: 'Scrafty' },
  { id: 561, name: 'Sigilyph' },
  { id: 562, name: 'Yamask' }, { id: 563, name: 'Cofagrigus' },
  { id: 564, name: 'Tirtouga' }, { id: 565, name: 'Carracosta' },
  { id: 566, name: 'Archen' }, { id: 567, name: 'Archeops' },
  { id: 568, name: 'Trubbish' }, { id: 569, name: 'Garbodor' },
  { id: 570, name: 'Zorua' }, { id: 571, name: 'Zoroark' },
  { id: 572, name: 'Minccino' }, { id: 573, name: 'Cinccino' },
  { id: 574, name: 'Gothita' }, { id: 575, name: 'Gothorita' }, { id: 576, name: 'Gothitelle' },
  { id: 577, name: 'Solosis' }, { id: 578, name: 'Duosion' }, { id: 579, name: 'Reuniclus' },
  { id: 580, name: 'Ducklett' }, { id: 581, name: 'Swanna' },
  { id: 582, name: 'Vanillite' }, { id: 583, name: 'Vanillish' }, { id: 584, name: 'Vanilluxe' },
  { id: 585, name: 'Deerling' }, { id: 586, name: 'Sawsbuck' },
  { id: 587, name: 'Emolga' },
  { id: 588, name: 'Karrablast' }, { id: 589, name: 'Escavalier' },
  { id: 590, name: 'Foongus' }, { id: 591, name: 'Amoonguss' },
  { id: 592, name: 'Frillish' }, { id: 593, name: 'Jellicent' },
  { id: 594, name: 'Alomomola' },
  { id: 595, name: 'Joltik' }, { id: 596, name: 'Galvantula' },
  { id: 597, name: 'Ferroseed' }, { id: 598, name: 'Ferrothorn' },
  { id: 599, name: 'Klink' }, { id: 600, name: 'Klang' }, { id: 601, name: 'Klinklang' },
  { id: 602, name: 'Tynamo' }, { id: 603, name: 'Eelektrik' }, { id: 604, name: 'Eelektross' },
  { id: 605, name: 'Elgyem' }, { id: 606, name: 'Beheeyem' },
  { id: 607, name: 'Litwick' }, { id: 608, name: 'Lampent' }, { id: 609, name: 'Chandelure' },
  { id: 610, name: 'Axew' }, { id: 611, name: 'Fraxure' }, { id: 612, name: 'Haxorus' },
  { id: 613, name: 'Cubchoo' }, { id: 614, name: 'Beartic' },
  { id: 615, name: 'Cryogonal' },
  { id: 616, name: 'Shelmet' }, { id: 617, name: 'Accelgor' },
  { id: 618, name: 'Stunfisk' },
  { id: 619, name: 'Mienfoo' }, { id: 620, name: 'Mienshao' },
  { id: 621, name: 'Druddigon' },
  { id: 622, name: 'Golett' }, { id: 623, name: 'Golurk' },
  { id: 624, name: 'Pawniard' }, { id: 625, name: 'Bisharp' },
  { id: 626, name: 'Bouffalant' },
  { id: 627, name: 'Rufflet' }, { id: 628, name: 'Braviary' },
  { id: 629, name: 'Vullaby' }, { id: 630, name: 'Mandibuzz' },
  { id: 631, name: 'Heatmor' },
  { id: 632, name: 'Durant' },
  { id: 633, name: 'Deino' }, { id: 634, name: 'Zweilous' }, { id: 635, name: 'Hydreigon' },
  { id: 636, name: 'Larvesta' }, { id: 637, name: 'Volcarona' },
  { id: 638, name: 'Cobalion' }, { id: 639, name: 'Terrakion' }, { id: 640, name: 'Virizion' },
  { id: 641, name: 'Tornadus' }, { id: 642, name: 'Thundurus' },
  { id: 643, name: 'Reshiram' }, { id: 644, name: 'Zekrom' },
  ...
  { id: 659, name: 'Bunnelby' }, { id: 660, name: 'Diggersby' },
  { id: 661, name: 'Fletchling' }, { id: 662, name: 'Fletchinder' }, { id: 663, name: 'Talonflame' },
  { id: 664, name: 'Scatterbug' }, { id: 665, name: 'Spewpa' }, { id: 666, name: 'Vivillon' },
  { id: 667, name: 'Litleo' }, { id: 668, name: 'Pyroar' },
  { id: 669, name: 'Flabébé' }, { id: 670, name: 'Floette' }, { id: 671, name: 'Florges' },
  { id: 672, name: 'Skiddo' }, { id: 673, name: 'Gogoat' },
  { id: 674, name: 'Pancham' }, { id: 675, name: 'Pangoro' },
  { id: 676, name: 'Furfrou' },
  { id: 677, name: 'Espurr' }, { id: 678, name: 'Meowstic' },
  { id: 679, name: 'Honedge' }, { id: 680, name: 'Doublade' }, { id: 681, name: 'Aegislash' },
  { id: 682, name: 'Spritzee' }, { id: 683, name: 'Aromatisse' },
  { id: 684, name: 'Swirlix' }, { id: 685, name: 'Slurpuff' },
  { id: 686, name: 'Inkay' }, { id: 687, name: 'Malamar' },
  { id: 688, name: 'Binacle' }, { id: 689, name: 'Barbaracle' },
  { id: 690, name: 'Skrelp' }, { id: 691, name: 'Dragalge' },
  { id: 692, name: 'Clauncher' }, { id: 693, name: 'Clawitzer' },
  { id: 694, name: 'Helioptile' }, { id: 695, name: 'Heliolisk' },
  { id: 696, name: 'Tyrunt' }, { id: 697, name: 'Tyrantrum' },
  { id: 698, name: 'Amaura' }, { id: 699, name: 'Aurorus' },
  { id: 700, name: 'Sylveon' },
  ...
  { id: 707, name: 'Klefki' },
  { id: 708, name: 'Phantump' }, { id: 709, name: 'Trevenant' },
  { id: 710, name: 'Pumpkaboo' }, { id: 711, name: 'Gourgeist' },
  { id: 712, name: 'Bergmite' }, { id: 713, name: 'Avalugg' },
  { id: 714, name: 'Noibat' }, { id: 715, name: 'Noivern' },
  ...
  { id: 734, name: 'Yungoos' }, { id: 735, name: 'Gumshoos' },
  { id: 736, name: 'Grubbin' }, { id: 737, name: 'Charjabug' }, { id: 738, name: 'Vikavolt' },
  { id: 739, name: 'Crabrawler' }, { id: 740, name: 'Crabominable' },
  { id: 741, name: 'Oricorio' },
  { id: 742, name: 'Cutiefly' }, { id: 743, name: 'Ribombee' },
  { id: 744, name: 'Rockruff' }, { id: 745, name: 'Lycanroc' },
  { id: 746, name: 'Wishiwashi' },
  { id: 747, name: 'Mareanie' }, { id: 748, name: 'Toxapex' },
  { id: 749, name: 'Mudbray' }, { id: 750, name: 'Mudsdale' },
  { id: 751, name: 'Dewpider' }, { id: 752, name: 'Araquanid' },
  { id: 753, name: 'Fomantis' }, { id: 754, name: 'Lurantis' },
  { id: 755, name: 'Morelull' }, { id: 756, name: 'Shiinotic' },
  { id: 757, name: 'Salandit' }, { id: 758, name: 'Salazzle' },
  { id: 759, name: 'Stufful' }, { id: 760, name: 'Bewear' },
  { id: 761, name: 'Bounsweet' }, { id: 762, name: 'Steenee' }, { id: 763, name: 'Tsareena' },
  { id: 764, name: 'Comfey' },
  { id: 765, name: 'Oranguru' },
  { id: 766, name: 'Passimian' },
  { id: 767, name: 'Wimpod' }, { id: 768, name: 'Golisopod' },
  { id: 769, name: 'Sandygast' }, { id: 770, name: 'Palossand' },
  { id: 771, name: 'Pyukumuku' },
  { id: 772, name: 'Type: Null' }, { id: 773, name: 'Silvally' },
  { id: 774, name: 'Minior' },
  { id: 775, name: 'Komala' },
  ...
  { id: 785, name: 'Tapu Koko' }, { id: 786, name: 'Tapu Lele' },
  { id: 787, name: 'Tapu Bulu' }, { id: 788, name: 'Tapu Fini' },
  { id: 789, name: 'Cosmog' }, { id: 790, name: 'Cosmoem' },
  { id: 791, name: 'Solgaleo' }, { id: 792, name: 'Lunala' },
  { id: 793, name: 'Nihilego' }, { id: 794, name: 'Buzzwole' }, { id: 795, name: 'Pheromosa' },
  { id: 796, name: 'Xurkitree' }, { id: 797, name: 'Celesteela' }, { id: 798, name: 'Kartana' },
  { id: 799, name: 'Guzzlord' },
  { id: 800, name: 'Necrozma' },
  { id: 801, name: 'Magearna' }, { id: 802, name: 'Marshadow' },
  { id: 803, name: 'Poipole' }, { id: 804, name: 'Naganadel' },
  { id: 805, name: 'Stakataka' }, { id: 806, name: 'Blacephalon' },
  { id: 807, name: 'Zeraora' },
  { id: 808, name: 'Meltan' }, { id: 809, name: 'Melmetal' },
  ...
  { id: 819, name: 'Skwovet' }, { id: 820, name: 'Greedent' },
  { id: 821, name: 'Rookidee' }, { id: 822, name: 'Corvisquire' }, { id: 823, name: 'Corviknight' },
  { id: 824, name: 'Blipbug' }, { id: 825, name: 'Dottler' }, { id: 826, name: 'Orbeetle' },
  { id: 827, name: 'Nickit' }, { id: 828, name: 'Thievul' },
  { id: 829, name: 'Gossifleur' }, { id: 830, name: 'Eldegoss' },
  { id: 831, name: 'Wooloo' }, { id: 832, name: 'Dubwool' },
  { id: 833, name: 'Chewtle' }, { id: 834, name: 'Drednaw' },
  { id: 835, name: 'Yamper' }, { id: 836, name: 'Boltund' },
  { id: 837, name: 'Rolycoly' }, { id: 838, name: 'Carkol' }, { id: 839, name: 'Coalossal' },
  { id: 840, name: 'Applin' }, { id: 841, name: 'Flapple' }, { id: 842, name: 'Appletun' },
  { id: 843, name: 'Silicobra' }, { id: 844, name: 'Sandaconda' },
  { id: 845, name: 'Cramorant' },
  { id: 846, name: 'Arrokuda' }, { id: 847, name: 'Barraskewda' },
  { id: 848, name: 'Toxel' }, { id: 849, name: 'Toxtricity' },
  { id: 850, name: 'Sizzlipede' }, { id: 851, name: 'Centiskorch' },
  { id: 852, name: 'Clobbopus' }, { id: 853, name: 'Grapploct' },
  { id: 854, name: 'Sinistea' }, { id: 855, name: 'Polteageist' },
  { id: 856, name: 'Hatenna' }, { id: 857, name: 'Hattrem' }, { id: 858, name: 'Hatterene' },
  { id: 859, name: 'Impidimp' }, { id: 860, name: 'Morgrem' }, { id: 861, name: 'Grimmsnarl' },
  ...
  { id: 868, name: 'Milcery' }, { id: 869, name: 'Alcremie' },
  { id: 870, name: 'Falinks' },
  { id: 871, name: 'Pincurchin' },
  { id: 872, name: 'Snom' }, { id: 873, name: 'Frosmoth' },
  { id: 874, name: 'Stonjourner' },
  { id: 875, name: 'Eiscue' },
  { id: 876, name: 'Indeedee' },
  { id: 877, name: 'Morpeko' },
  { id: 878, name: 'Cufant' }, { id: 879, name: 'Copperajah' },
  { id: 880, name: 'Dracozolt' }, { id: 881, name: 'Arctozolt' },
  { id: 882, name: 'Dracovish' }, { id: 883, name: 'Arctovish' },
  { id: 884, name: 'Duraludon' },
  { id: 885, name: 'Dreepy' }, { id: 886, name: 'Drakloak' }, { id: 887, name: 'Dragapult' },
  { id: 888, name: 'Zacian' }, { id: 889, name: 'Zamazenta' },
  { id: 890, name: 'Eternatus' },
  { id: 891, name: 'Kubfu' }, { id: 892, name: 'Urshifu' },
  { id: 893, name: 'Zarude' },
  { id: 894, name: 'Regieleki' }, { id: 895, name: 'Regidrago' },
  { id: 896, name: 'Glastrier' }, { id: 897, name: 'Spectrier' },
  { id: 898, name: 'Calyrex' },
  { id: 899, name: 'Wyrdeer' },
  { id: 900, name: 'Kleavor' },
  ...
  { id: 915, name: 'Lechonk' }, { id: 916, name: 'Oinkologne' },
  { id: 917, name: 'Tarountula' }, { id: 918, name: 'Spidops' },
  { id: 919, name: 'Nymble' }, { id: 920, name: 'Lokix' },
  { id: 921, name: 'Pawmi' }, { id: 922, name: 'Pawmo' }, { id: 923, name: 'Pawmot' },
  { id: 924, name: 'Tandemaus' }, { id: 925, name: 'Maushold' },
  { id: 926, name: 'Fidough' }, { id: 927, name: 'Dachsbun' },
  { id: 928, name: 'Smoliv' }, { id: 929, name: 'Dolliv' }, { id: 930, name: 'Arboliva' },
  { id: 931, name: 'Squawkabilly' },
  { id: 932, name: 'Nacli' }, { id: 933, name: 'Naclstack' }, { id: 934, name: 'Garganacl' },
  { id: 935, name: 'Charcadet' }, { id: 936, name: 'Armarouge' }, { id: 937, name: 'Ceruledge' },
  { id: 938, name: 'Tadbulb' }, { id: 939, name: 'Bellibolt' },
  { id: 940, name: 'Wattrel' }, { id: 941, name: 'Kilowattrel' },
  { id: 942, name: 'Maschiff' }, { id: 943, name: 'Mabosstiff' },
  { id: 944, name: 'Shroodle' }, { id: 945, name: 'Grafaiai' },
  { id: 946, name: 'Bramblin' }, { id: 947, name: 'Brambleghast' },
  { id: 948, name: 'Toedscool' }, { id: 949, name: 'Toedscruel' },
  { id: 950, name: 'Klawf' },
  { id: 951, name: 'Capsakid' }, { id: 952, name: 'Scovillain' },
  { id: 953, name: 'Rellor' }, { id: 954, name: 'Rabsca' },
  { id: 955, name: 'Flittle' }, { id: 956, name: 'Espathra' },
  { id: 957, name: 'Tinkatink' }, { id: 958, name: 'Tinkatuff' }, { id: 959, name: 'Tinkaton' },
  { id: 960, name: 'Wiglett' }, { id: 961, name: 'Wugtrio' },
  { id: 962, name: 'Bombirdier' },
  { id: 963, name: 'Finizen' }, { id: 964, name: 'Palafin' },
  { id: 965, name: 'Varoom' }, { id: 966, name: 'Revavroom' },
  { id: 967, name: 'Cyclizar' },
  { id: 968, name: 'Orthworm' },
  { id: 969, name: 'Glimmet' }, { id: 970, name: 'Glimmora' },
  { id: 971, name: 'Greavard' }, { id: 972, name: 'Houndstone' },
  { id: 973, name: 'Flamigo' },
  { id: 974, name: 'Cetoddle' }, { id: 975, name: 'Cetitan' },
  { id: 976, name: 'Veluza' },
  { id: 977, name: 'Dondozo' },
  ...
  { id: 984, name: 'Great Tusk' }, { id: 985, name: 'Scream Tail' },
  { id: 986, name: 'Brute Bonnet' }, { id: 987, name: 'Flutter Mane' },
  { id: 988, name: 'Slither Wing' }, { id: 989, name: 'Sandy Shocks' },
  { id: 990, name: 'Iron Treads' }, { id: 991, name: 'Iron Bundle' },
  { id: 992, name: 'Iron Hands' }, { id: 993, name: 'Iron Jugulis' },
  { id: 994, name: 'Iron Moth' }, { id: 995, name: 'Iron Thorns' },
  { id: 996, name: 'Frigibax' }, { id: 997, name: 'Arctibax' }, { id: 998, name: 'Baxcalibur' },
  { id: 999, name: 'Gimmighoul' }, { id: 1000, name: 'Gholdengo' },
  { id: 1001, name: 'Wo-Chien' }, { id: 1002, name: 'Chien-Pao' },
  { id: 1003, name: 'Ting-Lu' }, { id: 1004, name: 'Chi-Yu' },
  { id: 1005, name: 'Roaring Moon' }, { id: 1006, name: 'Iron Valiant' },
  { id: 1007, name: 'Koraidon' }, { id: 1008, name: 'Miraidon' },
  { id: 1009, name: 'Walking Wake' }, { id: 1010, name: 'Iron Leaves' },
